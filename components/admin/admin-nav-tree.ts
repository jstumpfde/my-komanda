...
export const ADMIN_NAV_TREE: AdminNavCategory[] = [
  ...
  { title: "Витрина страниц",  icon: Globe,           items: [{ label: "Витрина страниц",  href: "/admin/platform/client-pages", icon: Globe }] },
  { title: "Типология",       icon: Star,            items: [{ label: "Типология",        href: "/admin/tip",                  icon: Star }] },
  {
    title: "Платформа",
    icon: ShieldAlert,
    items: [
      ...
      { label: "Стоп-слова", href: "/admin/platform/stop-words", icon: Shield },
      ...
      { label: "Big Life: обложки", href: "/admin/platform/big-life-covers", icon: ImageIcon },
    ],
  },
]
