...
const FULL_TEMPLATES: FullTemplate[] = [
  {
    ...
    lessons: [
      ...
      mkLesson("t1-9","📍","Офис и команда","Современный офис в центре города.\n\n• Кухня и зона отдыха\n• Парковка\n• Команда: дружелюбная и профессиональная"),
  ...
  },
  {
    ...
    lessons: [
      ...
      mkLesson("t2-2","🏢","О компании","{{компания}} — динамично растущая компания {{в_городе}}."),
  ...
  },
  {
    ...
    lessons: [
      ...
      mkLesson("t7-2","🏭","О предприятии","{{компания}} — производственное предприятие {{в_городе}}."),
