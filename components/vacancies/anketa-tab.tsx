...
// "required" — обязательный критерий: не соответствует → отказ (knockout).
// Используется только для кастом-критериев; встроенные оси остаются весовыми.
type AiWeightLevel = "required" | "critical" | "important" | "nice" | "irrelevant"
