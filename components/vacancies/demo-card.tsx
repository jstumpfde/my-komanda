...
const DEMO_EMOJI_NAMES: Record<string, string> = {
  ...
  "⚽":"футбол мяч","🏓":"падел теннис настольный","🎾":"теннис ракетка","🏀":"баскетбол","🏈":"американский футбол","⚾":"бейсбол","🎱":"бильярд","🏐":"волейбол","🏉":"регби","🥏":"фрисби","🏸":"бадминтон","🏒":"хоккей","🥊":"бокс перчатки","🥋":"единоборства","🎿":"лыжи","⛷️":"лыжник","🏂":"сноуборд","🏋️":"штанга зал","🤸":"гимнастика","🏊":"плавание","🚴":"велосипед","🧘":"йога","🏄":"сёрфинг","🤽":"водное поло","🎯":"дартс цель","🎳":"боулинг","🏆":"кубок победа","🥇":"золото первое место","🥈":"серебро","🥉":"бронза",
}
