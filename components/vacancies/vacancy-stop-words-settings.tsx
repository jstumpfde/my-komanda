  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Если в ответе кандидата (в hh-чате или анкете) встретится одно из этих
          слов или фраз — он автоматически попадает в стадию «Отказ», касания
          дожима отменяются. Поиск по подстроке, регистр не учитывается.
        </CardDescription>
      </CardHeader>
