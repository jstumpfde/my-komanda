...
export interface Candidate {
  ...
  // Задача 4 (14.07, корректировка v2): номера ВСЕХ пройденных демо-блоков —
  // бейдж-комбинация «Д1+2» (см. lib/demo/block-completion.ts). [] = ничего.
  completedDemoBlockIndexes?: number[]
  // Готовый текст построчного тултипа («Д1 «Презентация» — пройден, балл 72\n…»).
