...
const PUBLIC_PREFIXES = [
  ...
  "/start/",            // универсальная (обезличенная) ссылка на контент-блок
                        // вакансии — форма «Имя+Телефон», см. drizzle/0278.
                        // ПРИМЕЧАНИЕ: "/join/" уже занят company-join по коду
                        // (app/(public)/join/[code]) — поэтому новый сегмент.
  "/join/",
  ...
  "/privacy",
  "/terms",
  "/portfolio",          // публичное портфолио веб-разработки Company24.pro + форма заявки
