...
export const AUTO_REASON_LABELS: Record<string, string> = {
  ...
  // Воронка 3: красная зона трёхзонного гейта без авто-отказа — на ручной разбор.
  funnel_v2_red_zone:            "Воронка: красная зона — ручной разбор",
  // Воронка 3: v2 включён, но все стадии выключены — автообработка не запускалась.
  funnel_v2_no_enabled_stage:    "Воронка: все стадии выключены — ручной разбор",
  // Воронка 3: продвижение невозможно (выключенный хвост/самопереход) — кандидат
  // на ручном разборе; funnel-v2-tick возобновит, когда стадию включат обратно.
  funnel_v2_hold:                "Воронка: продвижение на паузе — ручной разбор",
  // Инцидент 06.07 (Ильин, вакансия 6916): кандидат в чате отказался от
  // конкретного требования вакансии — дожим на паузе, ждёт решения HR
  ...
  // Входной гейт настроен, но AI-скоринг резюме не смог посчитать балл за
  // предельное время (4 ч) — авто-обработка остановлена, кандидат на ручном
  // разборе (lib/hh/process-queue.ts, guard-major 06.07).
  entry_gate_ai_scoring_stuck:    "Портрет: AI не смог оценить резюме — ручной разбор",
}
