// Общий загрузчик данных для платформенной admin-панели.
// Используется всеми подстраницами /admin/platform/{section}.
...
export async function loadPlatformAdminData() {
