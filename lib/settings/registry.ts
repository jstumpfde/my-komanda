...
export const SETTINGS_REGISTRY: SettingsRegistryEntry[] = [
  ...
  {
    key: "schedule.interviewReminderTextCandidate",
    title: "Тексты напоминаний кандидату (4 порога)",
    description: "24ч/утро/1ч/15мин — сообщение в hh-чат. Плейсхолдеры {{when}}/{{title}}/{{location}}/{{reschedule_link}} — см. REMINDER_TEXT_VARS в lib/hr/interview-reminder-texts.ts. Пусто → дефолт (байт-в-байт как раньше).",
    group: "Расписание и интервью",
    level: "company",
    editPath: "/hr/calendar?settings=1",
    resolve: { kind: "companyHiringDefaults", path: "schedule.reminderTexts.candidate", default: null },
  },
  {
    key: "schedule.interviewReminderTextHr",
    title: "Тексты напоминаний HR-каналу (4 порога)",
    description: "Текст in-app уведомления и Telegram-канала компании. Те же плейсхолдеры, кроме {{reschedule_link}}.",
    group: "Расписание и интервью",
    level: "company",
    editPath: "/hr/calendar?settings=1",
    resolve: { kind: "companyHiringDefaults", path: "schedule.reminderTexts.hr", default: null },
  },
  {
    key: "schedule.interviewReminderTextManager",
    title: "Тексты напоминаний менеджеру (4 порога)",
    description: "Telegram-сообщение менеджеру-создателю события (@Ren_HR_bot). Те же плейсхолдеры, кроме {{reschedule_link}}.",
    group: "Расписание и интервью",
    level: "company",
    editPath: "/hr/calendar?settings=1",
    resolve: { kind: "companyHiringDefaults", path: "schedule.reminderTexts.manager", default: null },
  },
  {
    key: "schedule.interviewReminderLeadLabel",
    title: "Лид-фраза напоминания («через час» и т.п.)",
    description: "Короткая метка — заголовок in-app уведомления и первая строка Telegram-сообщения HR/менеджеру. Само сообщение полностью редактируемо (см. три записи выше); эта метка — сознательно оставленный минимальный остаток хардкода.",
    group: "Расписание и интервью",
    level: "platform",
    editPath: null,
    hardcoded: true,
