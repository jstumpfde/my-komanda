...
- "reject" — высокая уверенность что кандидат НЕ подходит (явный мисматч: профессия кардинально другая, опыт 0 при требовании 3+ лет, явное несоответствие обязательным навыкам из СТОП-ФАКТОРОВ).
