...
export const CRON_REGISTRY: CronEntry[] = [
  ...
  },
  {
    ...
    schedule: "30 2 * * *",
    description: "Синхронизация статуса вакансий hh: проверка archived-флага через детальный API",
  },
  {
  ...
  },
  {
    ...
    schedule: "*/15 * * * *",
    description: "Дожим лидов продаж: шаблонные сообщения активным диалогам без брони",
  },
  {
    name: "trash-cleanup",
