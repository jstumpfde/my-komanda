...
> Новый чат: прочитай ЭТОТ файл первым. Это подробнейший отчёт обо всём, что
> сделано в большой автономной сессии. Всё — на СТЕЙДЖИНГЕ (new.company24.pro),
> прод (company24.pro) НЕ трогали, реальный outward (рассылки кандидатам) НЕ включали.
> Ветка develop, HEAD на момент написания — **0f7dac5e**.
