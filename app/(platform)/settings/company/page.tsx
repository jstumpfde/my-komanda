        ...
        <Card>
          ...
          <CardContent className="px-5 pb-4 pt-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="space-y-1 sm:col-span-2"><Label className="text-sm flex items-center gap-1.5"><Mail className="w-3.5 h-3.5 text-muted-foreground" /> Контактный email компании</Label><Input type="email" value={email} {...field("email", setEmail)} placeholder="legal@вашдомен.ru" className={cn(ph, errors.email && "border-red-400 focus-visible:ring-red-400")} /><FieldError error={errors.email} /><p className="text-xs text-muted-foreground flex items-start gap-1.5 mt-0.5"><Info className="w-3.5 h-3.5 mt-0.5 shrink-0 text-blue-500" /><span>Укажите реальный ящик и регулярно проверяйте его — на него приходят обращения по политике конфиденциальности и запросы по персональным данным. Этот же адрес подставляется в юридические документы.</span></p></div>
