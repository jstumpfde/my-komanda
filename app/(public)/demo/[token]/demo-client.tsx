                  ...
                  <div className="space-y-4">
                    {fieldPhone.enabled && (
                      <div className="space-y-1">
                        ...
                        <Input value={formPhone} onChange={e => setFormPhone(maskPhoneRu(e.target.value))} placeholder="+7 (999) 123-45-67" inputMode="tel" className={inputClass} style={inputStyle} />
                      </div>
                    )}
