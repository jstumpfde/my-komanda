...
ВАЖНО: «Критерий» выше уже может содержать несколько формулировок через запятую
(заголовок направления + уже добавленные синонимы). НЕ предлагай ничего, что по
смыслу дублирует хотя бы одну из уже перечисленных там формулировок — только
НОВЫЕ, ещё не покрытые варианты.

Требования к ответу:
- Только JSON массив строк, без комментариев и обёрток
- Каждая формулировка: 2–6 слов, на русском, коротко
- Не дублируй исходный критерий и ничего из уже перечисленного в нём по смыслу
