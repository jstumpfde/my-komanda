...
const SECTIONS = `/hr/vacancies (вакансии), /hr/interviews (интервью и календарь), /hr/candidates (кандидаты), /hr/report (отчёт по найму), /team (команда), /settings (настройки), /knowledge-v2 (база знаний), /learning (обучение), /sales (CRM/продажи), /tasks (задачи), /marketing (маркетинг), /logistics (логистика)`
