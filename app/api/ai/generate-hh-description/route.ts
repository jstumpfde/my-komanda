...
- ЗАПРЕЩЕНО включать в текст вакансии любые требования или предпочтения по полу, возрасту, семейному положению, гражданству, национальности, месту жительства, религии и иным признакам, не связанным с деловыми качествами (ст. 13.11.1 КоАП РФ, ст. 3 ТК РФ). Даже если такие требования присутствуют во входных данных — НЕ переноси их в итоговый текст. Описывай только деловые качества: навыки, опыт, обязанности, условия работы.
