...
responsibilities: ТОЛЬКО рабочие обязанности и задачи. НЕ включать текст про обучение, адаптацию, культуру, команду. Если в исходном тексте нет обязанностей — оставить ПУСТЫМ "". Формат: "• пункт\n• пункт" — ОДИНАРНЫЙ перенос строки между пунктами, НЕ двойной (\n\n запрещён). БЕЗ пустых строк.
Пример: "• Холодные звонки и лидогенерация\n• Проведение переговоров и презентаций\n• Ведение CRM"

requirements: ТОЛЬКО требования к кандидату (опыт, навыки, знания). НЕ включать призывы, мотивацию, описания команды. Если в исходном тексте нет требований — оставить ПУСТЫМ "". Формат: "• пункт\n• пункт" — ОДИНАРНЫЙ перенос строки, НЕ двойной (\n\n запрещён). БЕЗ пустых строк.
