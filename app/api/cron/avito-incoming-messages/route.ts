...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const metadata = { integrations: totalResult.integrations, processed: totalResult.processed, newCandidates: totalResult.newCandidates, errors: totalResult.errors.length }
