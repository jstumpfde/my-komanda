...
import { PlanEditSheet } from "@/components/admin/plans/plan-edit-sheet"
import {
  ...
  return (
    <AdminPageLayout>
      <div className="py-6 px-8">
          ...
          <DataTable containerClassName="overflow-x-auto">
            ...
            <tbody>
              ...
              {!loading && plans.map(plan => (
                <DataRow key={plan.id} onClick={view === "active" ? () => setSheetPlan(plan) : undefined} className={view === "active" ? "cursor-pointer" : undefined}>
                  <DataCell>
                    ...
                    <div className="flex justify-end" onClick={e => e.stopPropagation()}>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-52">
                          ...
                          {view === "active" && (
                            <>
                              <DropdownMenuItem className="gap-2 cursor-pointer" onClick={() => setSheetPlan(plan)}>
        ...
        {/* Редактор тарифа прямо в боковой панели (клик по строке активного тарифа).
            Архив/Корзина/Восстановление — через «⋮» в строке. */}
        <PlanEditSheet
          planId={sheetPlan?.id ?? null}
          open={!!sheetPlan}
          onOpenChange={(o) => { if (!o) setSheetPlan(null) }}
          onSaved={refetch}
        />
