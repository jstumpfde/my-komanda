      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Партнёрская программа</p>
          </div>
        </div>
        ...
        <Card className="border">
          <CardContent className="pt-6 pb-6 space-y-5">
            {submitted ? (
              ...
              <div className="text-center space-y-4 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Мы свяжемся с вами в ближайшее время по поводу подключения к партнёрской программе
                  </p>
                </div>
                <Link href="/login">
              ...
              <>
                <div>
                  <h2 className="text-lg font-semibold text-foreground">Стать партнёром</h2>
                  <p className="text-sm text-muted-foreground">
                    Оставьте заявку — мы подключим вас к партнёрской программе и откроем кабинет
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <Label htmlFor="req-company">Название компании</Label>
                    <Input
                      id="req-company"
                      value={companyName}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Textarea
                      ...
                      placeholder="Расскажите о себе и о том, как планируете работать..."
                      rows={3}
                    />
                  </div>
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Хотите подключить компанию?{" "}
                  <Link href="/register" className="text-primary hover:underline font-medium">Обычная заявка</Link>
                </p>
              </>
            )}
          </CardContent>
